...
% establishing ros communication
...
gripMessagePublisher = rospublisher('/servo_cmd', 'std_msgs/Int32');
...
gripMsg = rosmessage(gripMessagePublisher);
gripMsg.Data = 30;
...
for idx = 1:size(trajectory,2)
    ...
    jointMsg.Data = [configSoln(idx,:).JointPosition];
    send(jointMessagePublisher, jointMsg);
